...
function dibujarFilas(arregloLS) {
    ...
    for (let i in arregloLS) {
        ...
        <button class="btn btn-outline-warning ml-1" id="btnDestacar${arregloLS[i].codigo}" onclick="destacar(${arregloLS[i].codigo})" data-toggle="tooltip" data-placement="top" title="destacado"><i class="fas fa-star"></i></button></td>
        </tr>`;
...
window.destacar = function(codigo){
