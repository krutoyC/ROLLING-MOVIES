...
window.agregarPelicula = function (event) {
  ...
  if (
    validarNumero(document.getElementById("codigo")) &&
...
window.prepararPelicula = function (codigo) {
  ...
  document.getElementById("imagenDestacado").value =
    objetoEncontrado.imagenDestacado;
    ...
    if (listaPeliculas[i].codigo == objetoDestacado.codigo) {
      if (objetoDestacado.destacado == false) {
        ...
        document.getElementById(
          `btnDestacado${objetoDestacado.codigo}`
        ...
        for (let i in arregloFiltrado) {
          document
            .getElementById(`btnDestacado${arregloFiltrado[i].codigo}`)
